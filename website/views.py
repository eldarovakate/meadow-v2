...
def design_lab_home_blocks_view(request):
    ...
    context = {
        ...
        "hedgehog_print_image": img("Вышивка. 01. Принт Ёж в яблоках. Молочные_3.jpg"),
        "hare_print_image": img("Вышивка. 02. Заяц коричневый_вышивка_1.jpg"),
        ...
        "model_forest_wide_image": img("DSC09164.jpg"),
        "model_forest_world_image": img("DSC09103.jpg"),
        "model_arch_image": img("DSC09111.jpg"),
        "fabric_trail_image": img("DSC06548"),
        "garment_trail_image": img("DSC09177.jpg"),
        # Collection Statement Grid (11A-11E) — real photos from
        # "03. Фотосессии/Общие на сайт красивые", picked for these blocks specifically.
        "stmt_model_meadow_image": img("DSC08810.jpg"),
        "stmt_model_hedgehog_gold_image": img("DSC09092.jpg"),
        "stmt_model_hedgehog_gold_alt_image": img("DSC09093.jpg"),
        "stmt_model_hedgehog_gold_side_image": img("DSC08815.jpg"),
        "stmt_model_forest_34_image": img("DSC08785.jpg"),
        "stmt_model_arm_raised_image": img("DSC08793.jpg"),
        "stmt_model_backlit_image": img("DSC08811.jpg"),
        "stmt_moss_trunk_image": img("DSC01361.jpg"),
        "stmt_picnic_pines_image": img("DSC08317.jpg"),
        "stmt_fern_detail_image": img("DSC08420.jpg"),
        "stmt_autumn_lake_image": img("DSC01300.jpg"),
        "stmt_pine_branch_image": img("DSC08661.jpg"),
        "stmt_autumn_forest_image": img("DSC01398.jpg"),
        "stmt_geranium_image": img("DSC06249.jpg"),
        "stmt_moss_mushroom_image": img("DSC08540.jpg"),
        "stmt_willow_golden_image": img("DSC01258.jpg"),
        "stmt_willow_water_image": img("DSC09270.jpg"),
        "stmt_spiraea_image": img("DSC06113.jpg"),
    }
